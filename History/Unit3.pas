...
if p=0 then
   ...
   // sec:=strtoint(edit1.Text);
    ...
    if l=0 then label4.Caption:='Некорректно введены классы'
        else
           begin
           val(edit2.text,x,p);
           if p=0 then
             ...
             else label4.Caption:='Некорректно введено количество вопросов';
           end;

    end
else label4.Caption:='Некорректно введено время';
